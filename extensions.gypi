    ...
    ['OS=="mac" or OS=="linux"', {
      'variables': {
        'extension_libraries': [
          ...
          '<(libchromiumcontent_dir)/libcld_2.a',
    ...
    ['OS=="win"', {
      'variables': {
        'extension_libraries': [
          ...
          '<(libchromiumcontent_dir)/cld_2.lib',
