...
#ifndef BRAVE_COMMON_CONVERTERS_SCOPED_PERSISTENT_H_
#define BRAVE_COMMON_CONVERTERS_SCOPED_PERSISTENT_H_
...
#endif  // BRAVE_COMMON_CONVERTERS_SCOPED_PERSISTENT_H_
