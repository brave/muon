...
#ifndef BRAVE_COMMON_CONVERTERS_CALLBACK_CONVERTER_H_
#define BRAVE_COMMON_CONVERTERS_CALLBACK_CONVERTER_H_
...
#include "brave/common/converters/scoped_persistent.h"
...
struct V8FunctionInvoker<void(ArgTypes...)> {
  static void Go(v8::Isolate* isolate,
    ...
    std::vector<v8::Local<v8::Value>> args =
        std::vector<v8::Local<v8::Value>>{ ConvertToV8(isolate, raw)... };
...
#endif  // BRAVE_COMMON_CONVERTERS_CALLBACK_CONVERTER_H_
