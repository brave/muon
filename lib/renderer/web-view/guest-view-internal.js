...
var WEB_VIEW_EVENTS = {
  ...
  'did-attach': ['guestProxyRoutingId'],
  'did-finish-load': [],
  'did-start-provisional-load': ['validatedUrl', 'isErrorPage', 'isIframeSrcdoc', 'isMainFrame'],
  'did-commit-provisional-load': ['url', 'transitionType', 'isMainFrame'],
  'did-fail-provisional-load': ['errorCode', 'errorDescription', 'validatedURL', 'isMainFrame', 'ignoredByHandler'],
...
module.exports = {
  ...
  addGuest: function (params, callback) {
    requestId++
    ipcRenderer.send('ELECTRON_GUEST_VIEW_MANAGER_ADD_GUEST', params, requestId)
