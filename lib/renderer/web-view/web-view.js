...
var WebViewImpl = (function () {
  function WebViewImpl (webviewNode) {
    ...
    Object.defineProperty(this.webviewNode, 'contentWindow', {
      ...
      configurable: false,
      get: function() {
        var guestInstanceId = v8Util.getHiddenValue(this, 'internal').guestInstanceId
        var guest = remote.getGuestWebContents(guestInstanceId)
        if (guest) {
          return webFrame.getContentWindow(guest.getContentWindowId())
        } else {
          return null
        }
      }
  ...
  WebViewImpl.prototype.handleBrowserPluginAttributeMutation = function (attributeName, oldValue, newValue) {
    if (attributeName === webViewConstants.ATTRIBUTE_INTERNALINSTANCEID && !!newValue) {
      console.log('changin internalInstanceId from ' + oldValue + ' to ' + newValue)
  ...
  WebViewImpl.prototype.addGuest = function (guestInstanceId) {
    return guestViewInternal.addGuest(guestInstanceId, (function(_this) {
