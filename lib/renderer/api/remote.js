...
binding.getWebContents = function (tabId) {
  const res = ipcRenderer.sendSync('ELECTRON_BROWSER_GET_WEB_CONTENTS', tabId)
  return res && metaToValue(res)
}
...
const deprecatedRemoteAPIs = ['app', 'Menu', 'shell', 'screen', 'clipboard', 'session', 'systemPreferences', 'BrowserWindow']
