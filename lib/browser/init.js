...
// TOOD: Find a better way to do this, this is getting put before the app
// startup arg which needs to be first.
const index = process.argv.indexOf('--test-type=webdriver')
if (index > -1) {
  const removedItem = process.argv.splice(index, 1)[0]
  process.argv.push(removedItem)
}
