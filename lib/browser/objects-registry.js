...
class ObjectsRegistry {
  ...
  add (webContents, obj) {
    ...
    console.log('add webContentsId', webContentsId)
    ...
    if (!owner) {
      ...
      webContents.once('will-destroy', () => {
        console.log('will-destroy', webContentsId)
  ...
  remove (webContentsId, id) {
    console.log('remove webContentsId: ' + webContentsId + ' id: ' + id)
    console.log('owner', this.owners[webContentsId])
  ...
  clear (webContentsId) {
    console.log('clear', webContentsId)
    let owner = this.owners[webContentsId]
    if (!owner) return
