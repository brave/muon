...
#ifndef ATOM_BROWSER_EXTENSIONS_DEFAULT_EXTENSIONS_H_
#define ATOM_BROWSER_EXTENSIONS_DEFAULT_EXTENSIONS_H_
...
// Test: require('electron').remote.session.defaultSession.updateClient.install('aomjjhallfgjeglblehebfpbcfeobpgk') // NOLINT
...
// Test: require('electron').remote.session.defaultSession.updateClient.install('oemmndcbldboiebfnladdacbdfmadadm') // NOLINT
...
// Test: require('electron').remote.session.defaultSession.updateClient.install('fdjamakpfbbddfjaooikfcpapjohcfmg') // NOLINT
...
// Test: require('electron').remote.session.defaultSession.updateClient.install('hdokiejnpimakedhajhdlcegeplioahd') // NOLINT
...
#endif  // ATOM_BROWSER_EXTENSIONS_DEFAULT_EXTENSIONS_H_
