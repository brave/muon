...
#ifndef ATOM_BROWSER_EXTENSIONS_UPDATER_ATOM_UPDATE_CLIENT_CONFIG_H_
#define ATOM_BROWSER_EXTENSIONS_UPDATER_ATOM_UPDATE_CLIENT_CONFIG_H_
...
#endif  // ATOM_BROWSER_EXTENSIONS_UPDATER_ATOM_UPDATE_CLIENT_CONFIG_H_
